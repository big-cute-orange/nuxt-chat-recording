...
export default defineEventHandler(async (event: H3Event) => {
    ...
    return {
        ...
        actionsByOwner: Object.entries(ownerCounts)
            .sort((a, b) => b[1] - a[1])
            .slice(0, 8),
        topTopics: Object.entries(topicCounts)
            .sort((a, b) => b[1] - a[1])
            .slice(0, 12),
        meetingTypes: Object.entries(typeCounts)
            .sort((a, b) => b[1] - a[1])
            .slice(0, 6),
        priorityBreakdown: [
            {
                ...
                pct: Math.round((priorityCounts.high / total) * 100),
                color: '#dc2626',
            ...
            },
            {
                ...
                pct: Math.round((priorityCounts.medium / total) * 100),
                color: '#d97706',
            ...
            },
            {
                ...
                pct: Math.round((priorityCounts.low / total) * 100),
                color: '#16a34a',
