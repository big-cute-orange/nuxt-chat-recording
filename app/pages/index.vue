                            ...
                            <template v-else>
                                <div :key="side" class="compare-result">
                                    ...
                                    <div
                                        ...
                                        :class="{
                                            differs: valuesDiffer(
                                                !isError(compareResults.a.result)
                                                ...
                                                @click="
                                                    () => {
                                                        ...
                                                        if (result && compareResults && compareResults[side]) {
                                                            copyToClipboard(
                                                                buildMarkdown(result, providerName(compareResults[side].provider)),
                                                                `md-${side}`
                                                            );
                                                        }
                                                    }
                                            ...
                                            <button
                                                ...
                                                @click="
                                                    () => {
                                                        const result = getCompareResultAsAny(side);
                                                        if (result && compareResults && compareResults[side]) {
                                                            downloadMarkdown(result, providerName(compareResults[side].provider));
                                                        }
                                                    }
                                                "
                                            >
